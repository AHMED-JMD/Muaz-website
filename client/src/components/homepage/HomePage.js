  ...
  return (
    <div className="homepage">
              ...
              <div className="header-left">
                <div className="header-text">
                  ...
                  <h4 className="sub-header-txt">
                    {" "}
                    الاولي من نوعها في السودان{" "}
                  </h4>

                  <Link className="btn btn1  " to="#aboutus">
                    {" "}
                    ابدأ الان{" "}
                  </Link>
            ...
            <div className="aboutus-left ">
              <div className="about-text">
                <h1 className="text-center display-5">
                  {" "}
                  من <span className="cl-text">نحن؟ </span>{" "}
                </h1>
                <br />
                <h3>
                  <p>
                    <span className="bold">
                      شركة جياد لخدمات السيارات المحدودة،{" "}
                    </span>
                    شركة رائدة تعمل في مجال خدمات صيانة السيارات وخدمات ما بعد
                    البيع ، وهي امتداد لشركة جياد لصناعة السيارات - فخر الصناعة
                    في السودان - تأسست في عام 2004 ويقع مقرها بمدينة الخرطوم
                    جنوب غرب منطقة سباق الخيل كما أن لها وكلاء بمختلف المدن.{" "}
                  </p>
                  <p className="extra-info">
                    تمتلك الشركة في مقرها الرئيس ورشاً متطورة لأعمال الصيانة
                    الميكانيكية وكهرباء السيارات .
                  </p>
                </h3>
              </div>
            </div>
      ...
      <div className="container cont4">
        <h2 className="display-5 text-center ">
          {" "}
          تواصل <span className="cl-text">معنا</span>{" "}
        </h2>
                    ...
                    <p>
                      <span>
                        <img
                          ...
                          src="./images/phone-logo.webp"
                          alt="logo"
                        />
                      </span>
                      <span className="contact-txt">الهاتف: </span> 0126414252
                    </p>
                    <p>
                      <span>
                        <img
                      ...
                      <span className="contact-txt">الايميل: </span>{" "}
                      info@muaz-website.com
                    </p>
                    <p>
                      <span>
                        <img
                          className="contact-img"
                          src="./images/location-logo.webp"
                          alt="logo"
                        />
                      </span>
                      <span className="contact-txt">الموقع: </span> السودان
                      الخرطوم امدرمان بالقرب من محطة الشهداء
                    </p>
                  </div>
                  <form className="form">
                    ...
                    <button className="btn2 btn btn-lg" type="submit">
                      ارسل
                    </button>
                  </form>
                </div>
