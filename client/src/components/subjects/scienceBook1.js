        ...
        {/* <!--card1--> */}
                    ...
                    <div className="card">
                      ...
                      <div className="card-body">
                        ...
                        <Link to="/subjects-name?kind=علمي&chapter=الاحتمالات" className="btn btn8">
                          التفاصيل
                        </Link>
                      </div>
                    </div>
                ...
                <div className="col-lg-4 col-md-6 col-sm-12 " >
                    <div className="card">
                      ...
                      <div className="card-body">
                        ...
                        <Link to="/subjects-name?kind=علمي&chapter=الاحصاء" className="btn btn8">
                          التفاصيل
                        </Link>
                      </div>
                    </div>
                ...
                <div className="col-lg-4 col-md-6 col-sm-12 " >
                    <div className="card">
                      ...
                      <div className="card-body">
                        ...
                        <Link to="/subjects-name?kind=علمي&chapter=الكسور" className="btn btn8">
                          التفاصيل
                        </Link>
                      </div>
                    </div>
                ...
                <div className="col-lg-4 col-md-6 col-sm-12 " >
                    <div className="card">
                      ...
                      <div className="card-body">
                        ...
                        <Link to="/subjects-name?kind=علمي&chapter=المصفوفات" className="btn btn8">
                          التفاصيل
                        </Link>
                      </div>
                    </div>
                ...
                <div className="col-lg-4 col-md-6 col-sm-12 " >
                    <div className="card">
                      ...
                      <div className="card-body">
                        ...
                        <Link to="/subjects-name?kind=علمي&chapter=مبدأ العد" className="btn btn8">
                          التفاصيل
                        </Link>
                      </div>
                    </div>
